...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Package.alternative_name'
        db.add_column('djangopypi_package', 'alternative_name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Package.alternative_name'
        db.delete_column('djangopypi_package', 'alternative_name')
    ...
    models = {
        ...
        'djangopypi.package': {
            ...
            'alternative_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
